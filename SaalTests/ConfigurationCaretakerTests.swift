//
//  ConfigurationCaretakerTests.swift
//  SaalTests
//
...
class ConfigurationCaretakerTests: XCTestCase {
    ...
    func testSaveAndRestoreMemento() {
        //Given
        let configuration = Memento<Bool>.init(configuration: true)
        
        //when
        subjectUnderTest?.saveMemento(configurationMemento: configuration)
